  ...
  return (
    <div>
      <PageHeader
        ...
        action={<button onClick={openCreate} className="rounded-full bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">+ New {single.toLowerCase()}</button>}
      />
