  ...
  return {
    ...
    content: {
      ...
      neonInfo: {
        ...
        compare: { ...DEFAULT_CONTENT.neonInfo.compare, ...(c.neonInfo?.compare || {}) },
      },
      floroInfo: {
        ...
        compare: { ...DEFAULT_CONTENT.floroInfo.compare, ...(c.floroInfo?.compare || {}) },
      },
      ...
      pages: { ...DEFAULT_CONTENT.pages, ...(c.pages && typeof c.pages === 'object' ? c.pages : {}) },
    },
  };
}
